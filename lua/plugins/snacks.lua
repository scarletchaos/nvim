...
keymap("n", "<leader>gl", function() Snacks.lazygit.log() end, { desc = "Lazygit Log (cwd)" })
...
keymap("n", "<c-_>", function() Snacks.terminal() end, { desc = "Toggle Terminal" })
...
-- Auto command for lazy-loaded functionality
